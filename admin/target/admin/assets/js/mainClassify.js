$(function () {
     ...
     * 获取所有管理员列表
     */
    ajaxByPOST("/hy/main/classify/findMainClassifyCount", {type: 0}, initPersonCallback);
...
function initAllPersonPage(page) {
    currentPage = page;
    ajaxByPOST("/hy/main/classify/findMainAllClassify", {
...
$("select#selectForClass").click(function () {
    ...
    if (se == 0) {
        ...
        ajaxByPOST("/hy/main/classify/findMainClassifyCount", {type: 1}, initClassifyCallback);
...
function delPerson(id) {
    ...
    ajaxByPOST("/hy/main/classify/delMainClassify", {id: id}, forSuccess)
}

function editClassify(id) {


    window.location= "mainClassifyEdit.html?id="+id;
}
...
function addMainClassify() {
    ...
    window.location= "mainClassifyAdd.html";
